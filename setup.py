...
setup(
    ...
    author="Xabi Zubizarreta",
    author_email="xabi.zubi@gmail.com",
    description="Gets a random and sweet compliment to name your German girlfriend",
    license="TODO",
    keywords="german",
    url="https://github.com/oldbridge/schatznenner",
    py_modules=['schatznenner'],
    # TODO README.md is not available in the setup.py build directory
    ...
    entry_points={
        'console_scripts': ['schatznenner=schatznenner:main'],
    }
)
